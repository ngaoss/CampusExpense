...
public class AddRecurringExpenseActivity extends AppCompatActivity {
    ...
    private void showDeleteConfirmationDialog() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Delete", (dialog, which) -> deleteRule())
                .setNegativeButton("Cancel", null)
                .show();
    }
    private void deleteRule() {
        if (ruleId != -1L) {
            expenseDao.deleteRecurringRule(ruleId);
            Toast.makeText(this, "Rule deleted successfully.", Toast.LENGTH_SHORT).show();
